...
c      DTHT = 2.D0*PI/DFLOAT(NELGAM)
c---- following is for mode I symm case (1/2 ring)
      DTHT = PI/DFLOAT(NELGAM)
c
...
c     THT1=DFLOAT((NELGAM-N))*DTHT - PI
c     THT2=DFLOAT((NELGAM-N+1))*DTHT - PI
c---- following two statements are for mode I symm case (1/2 ring)
      tht1 = dfloat((nelgam-n))*dtht
      tht2 = dfloat((nelgam-n+1))*dtht
c
